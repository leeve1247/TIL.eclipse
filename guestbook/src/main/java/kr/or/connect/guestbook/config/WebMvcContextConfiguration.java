...
public class WebMvcContextConfiguration implements WebMvcConfigurer {
	...
	// configurer.enable(); 함으로써 매핑정보가 없는 url 요청을
	// configureDefaultServletHandling(DefaultServletHttpRequsetHandler)가 처리하는데,
	// 이러한 처리를 configurer.enable()하지 않으면 못한다.
	// 이런 부분들을 설정하게 함으로써 매핑이 없는 URL이 넘어왔을 때 WAS의 default servlet이 static 한 자원을 읽어서
	// 보여줄 수 있게끔 해준다.
